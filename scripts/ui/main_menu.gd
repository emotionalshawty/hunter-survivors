...
@onready var pilot_name_value: Label = $MainPanel/StatsPanel/Margin/VBox/PilotNameValue
@onready var stats_grid: GridContainer = $MainPanel/StatsPanel/Margin/VBox/StatsGrid
@onready var leaderboard_status: Label = $MainPanel/LeaderboardPanel/Margin/VBox/LeaderboardStatus
@onready var leaderboard_list: VBoxContainer = $MainPanel/LeaderboardPanel/Margin/VBox/LeaderboardList
@onready var play_button: Button = $MainPanel/CenterColumn/CenterStack/PlayButton
@onready var settings_button: Button = $MainPanel/CenterColumn/CenterStack/SettingsButton
@onready var sign_out_button: Button = $MainPanel/CenterColumn/CenterStack/SignOutButton
@onready var exit_button: Button = $MainPanel/CenterColumn/CenterStack/ExitButton
